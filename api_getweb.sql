...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=648332154ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="291">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_getweb&table=api_getweb_wp_posts">`api_getweb`.`api_getweb_wp_posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_getweb&table=api_getweb_wp_term_taxonomy">`api_getweb`.`api_getweb_wp_term_taxonomy`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_getweb&table=api_getweb_wp_term_relationships">`api_getweb`.`api_getweb_wp_term_relationships`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_getweb&table=api_getweb_wp_termmeta">`api_getweb`.`api_getweb_wp_termmeta`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_getweb&table=api_getweb_wp_terms">`api_getweb`.`api_getweb_wp_terms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api_getweb&table=api_getweb_wp_postmeta">`api_getweb`.`api_getweb_wp_postmeta`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_posts">`wordpress`.`wp_posts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6553557a764d704e225b4c3a2c314c74">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="291"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="api_getweb" targettable="api_getweb_wp_posts">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `api_getweb_wp_posts`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="api_getweb" targettable="api_getweb_wp_posts">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `ID`,`post_name` FROM `api_getweb_wp_posts` WHERE `post_type`=&#039;post&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="api_getweb" targettable="api_getweb_wp_posts">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT ID FROM api_getweb_wp_posts WHERE post_name=&#039;hello-world&#039;;</span>
                        </div>
